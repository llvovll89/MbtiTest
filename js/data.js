const qnaList = [
    ...
    },
    {
      ...
      a: [
        { answer: 'a. 박력 그 자체, "나랑 밥도먹고 뽀뽀도하자!" ', type: ['cow', 'tiger', 'dragon' ] },
        { answer: 'b. 섬세한 "나사실,,너 많이 좋아해 우리 사귈래??" ', type: ['sheep', 'dog', 'monkey', 'chick', 'pig' ] },
    ...
    },
    {
      ...
      a: [
        { answer: 'a. 쑥스러워.. 정수리터치,,', type: ['cow', 'sheep', 'dog', 'dragon', 'chick' ] },
        { answer: 'b. 허용범위 ON, 뽀뽀까지 가능해!', type: ['mouse', 'rabbit', 'horse', 'pig']},
  ...
  
    {
      ...
      a: [
        { answer: 'a. 무슨 기념일이야, 평범하게 넘어가자,,', type: ['dragon', 'chick', 'pig' ] },
        { answer: 'b. 맛있는 밥이나 사줄까? 아니면 예쁜 꽃이라도?', type: ['mouse', 'rabbit', 'horse', 'dog' ] },
        { answer: 'c. 이벤트 준비완료! 출격준비!', type: ['cow', 'sheep', 'tiger', 'snake', 'monkey' ] },
      ]
    },
    {
